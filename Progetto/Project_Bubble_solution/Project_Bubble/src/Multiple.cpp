...
// SHADERS
enum available_ShaderPrograms { MODELS, RAYMARCHING };
const char* print_available_ShaderPrograms[] = { "MODELS", "RAYMARCHING" };
...
void SetupShaders()
{
	...
	Shader shader1("src/shaders/reflect.vert", "src/shaders/RM_Blinn.frag");
	shaders.push_back(shader1);
	Shader shader2("src/shaders/reflect.vert", "src/shaders/RM_Stripes.frag");
	shaders.push_back(shader2);
	Shader shader3("src/shaders/reflect.vert", "src/shaders/RM_Reflection.frag");
	shaders.push_back(shader3);
	Shader shader4("src/shaders/reflect.vert", "src/shaders/RM_BubbleFresnel.frag");
	shaders.push_back(shader4);
	Shader shader5("src/shaders/reflect.vert", "src/shaders/RM_BN.frag");
