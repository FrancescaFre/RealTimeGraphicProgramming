/*
24_ggx_tex_dirlight.frag: fragment shader for GGX, with texturing.
...
float shadowCalculation (vec4 posLightSpace){
  vec3 projCoords = posLightSpace.xyz / posLightSpace.w; //divene fatto manualmente il perspective divide (-1, 1)

  //ora devo normalizzare il range da -1 a 1 --> 0 a 1
